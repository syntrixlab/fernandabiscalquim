...
export const ELEMENT_STYLE_REGISTRY: CategoryDef[] = [
  ...
  },
  {
    ...
    elements: [
      ...
      { id: 'recent-title', label: 'Título "Conteúdos recentes"', description: 'Título da seção de artigos recentes.', selector: '.app-shell .recent-posts-section .section-title h2', props: TEXT_ONLY, states: NORMAL_ONLY },
      { id: 'recent-bar', label: 'Barra degradê', description: 'Barrinha sob o título da seção de recentes.', selector: '.app-shell .recent-posts-section .section-title h2::after', props: ['bg'], states: NORMAL_ONLY, propLabelOverrides: { bg: 'Cor da barra' } },
      { id: 'recent-subtitle', label: 'Descrição da seção', description: 'Texto abaixo do título dos recentes.', selector: '.app-shell .recent-posts-section .section-title > p', props: TEXT_ONLY, states: NORMAL_ONLY }
    ]
  },
  {
    id: 'article-page',
